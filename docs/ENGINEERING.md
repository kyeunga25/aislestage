...
這份文件描述 AislePack v0.4 的公開工程合約。實際帳戶、資源名稱、identifier、URL、secret、使用者資料及營運記錄不屬於 repository 內容。
...
任何部署都必須先把 D1 migration 套用到經核對的目標環境，再部署相容 Worker。部署後至少檢查健康狀態、匿名 401、邀請 gate、登入、私人資產 headers、Campaign Pack 三輸出及 Queue 完成狀態。
