...
export function AccessGate({ reason = 'authentication-required' }: Props) {
  ...
  return <main className="access-gate">
    <a className="app-brand access-gate-brand" href="/" aria-label="AislePack 主頁"><BrandMark /><span><strong>AislePack</strong><small>AI 電商素材工作台</small></span></a>
    <section className="access-gate-card" aria-labelledby="access-gate-title">
      ...
      <p>{membershipRequired
        ? 'Cloudflare Access 已完成身份驗證，但這個帳戶沒有有效的 AislePack 工作區成員關係。請由管理員確認受邀電郵及帳戶狀態。'
        : configurationError
